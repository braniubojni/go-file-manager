...
- `frontend/bindings/**` generated by Wails — never hand-edit; **never `git add` / commit generated trees** (human stages those).
...
- Remote SMB: in-app `smb://` via `cloudsoda/go-smb2` (NTLM); Finder-style share picker; OS mounts listed in the drives menu (`/Volumes`).
